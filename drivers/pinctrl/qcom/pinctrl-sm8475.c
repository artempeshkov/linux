...
static const char * const phase_flag_groups[] = {
	"gpio4", "gpio5", "gpio6", "gpio7", "gpio10", "gpio11", "gpio12",
	"gpio13", "gpio14", "gpio15", "gpio16", "gpio17", "gpio18", "gpio19",
	"gpio25", "gpio26", "gpio76", "gpio77", "gpio78", "gpio79", "gpio81",
	"gpio82", "gpio83", "gpio92", "gpio93", "gpio94", "gpio95", "gpio96",
...
static const char * const qdss_gpio_groups[] = {
	"gpio100", "gpio101", "gpio102", "gpio103", "gpio104", "gpio105",
	"gpio106", "gpio107", "gpio110", "gpio111", "gpio112", "gpio113",
	"gpio114", "gpio115", "gpio117", "gpio118", "gpio119", "gpio120",
	"gpio188", "gpio189", "gpio190", "gpio191", "gpio192", "gpio193",
	"gpio194", "gpio195", "gpio196", "gpio197", "gpio198", "gpio199",
...
static const struct msm_gpio_wakeirq_map sm8475_pdc_map[] = {
	{ 2, 70 }, { 3, 77 }, { 7, 52 }, { 8, 108 }, { 10, 128 },
	{ 11, 53 }, { 12, 129 }, { 13, 130 }, { 14, 131 }, { 15, 67 },
	{ 19, 69 }, { 21, 132 }, { 23, 54 }, { 26, 56 }, { 27, 71 },
	{ 28, 57 }, { 31, 55 }, { 32, 58 }, { 34, 72 }, { 35, 43 },
	{ 36, 78 }, { 38, 79 }, { 39, 62 }, { 40, 80 }, { 41, 133 },
	{ 43, 81 }, { 44, 87 }, { 45, 134 }, { 46, 66 }, { 47, 63 },
	{ 50, 88 }, { 51, 89 }, { 55, 90 }, { 56, 59 }, { 59, 82 },
	{ 60, 60 }, { 62, 135 }, { 63, 91 }, { 66, 136 }, { 67, 44 },
	{ 69, 137 }, { 71, 97 }, { 75, 73 }, { 79, 74 }, { 80, 96 },
	{ 81, 98 }, { 82, 45 }, { 83, 99 }, { 84, 94 }, { 85, 100 },
	{ 86, 101 }, { 87, 102 }, { 88, 92 }, { 89, 83 }, { 90, 84 },
	{ 91, 85 }, { 92, 46 }, { 95, 103 }, { 96, 104 }, { 98, 105 },
	{ 99, 106 }, { 115, 95 }, { 116, 76 }, { 117, 75 }, { 118, 86 },
	{ 119, 93 }, { 133, 47 }, { 137, 42 }, { 148, 61 }, { 150, 68 },
	{ 153, 65 }, { 154, 48 }, { 155, 49 }, { 156, 64 }, { 159, 50 },
	{ 162, 51 }, { 166, 111 }, { 169, 114 }, { 171, 115 }, { 172, 116 },
	{ 174, 117 }, { 176, 107 }, { 181, 109 }, { 182, 110 }, { 185, 112 },
	{ 187, 113 }, { 188, 118 }, { 190, 122 }, { 192, 123 }, { 195, 124 },
